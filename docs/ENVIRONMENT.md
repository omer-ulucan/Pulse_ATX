...
| `HIDDENLAYER_CLIENT_ID`                | Live worker        | Server-only identifier | HiddenLayer OAuth client ID                                                      |
| `HIDDENLAYER_CLIENT_SECRET`            | Live worker        | Secret                 | HiddenLayer OAuth client secret                                                  |
| `HIDDENLAYER_AUTH_URL`                 | Optional           | Server-only URL        | HiddenLayer OAuth origin; defaults to `https://auth.hiddenlayer.ai`              |
